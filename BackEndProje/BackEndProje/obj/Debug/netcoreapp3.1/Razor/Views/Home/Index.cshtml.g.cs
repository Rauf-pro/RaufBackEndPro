#pragma checksum "C:\Users\User\Desktop\Back-End Project\BackEndProje\BackEndProje\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cb39c44b3267104983f8c6886f52e7eab6ee3928"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cb39c44b3267104983f8c6886f52e7eab6ee3928", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\User\Desktop\Back-End Project\BackEndProje\BackEndProje\Views\Home\Index.cshtml"
                ...
                <div class=""category-box-container text-center"">
                    <div class=""category-box"">
                        <div class=""category-box-content"">
                            ...
                            <h3><a href=""JavaScript:Voi");
            WriteLiteral(@"d(0);"" class=""text-white"">Eat & Drink</a></h3>
            ...
            <div class=""col-md-12"">
                <div class=""simple-slick-carousel dots-nav"">
                    <div class=""carousel-item"">
                        <div class=""category-box-container text-center"">
                            <div ");
            WriteLiteral(@"class=""listing-item-container"">
                                <div class=""listing-item text-center"">
                                    <div class=""mostviewed-bg"" style=""background-image: url('assets/images/most-img-4.jpg')"">
                                        <div class=""listing-item-content"">
                                            ...
                                            <span class=""badge badge-pill badge-primary text-uppercase open-close-banner"">Open<");
            WriteLiteral(@"/span>
                                        </div>
                            ...
                            <div class=""listing-item-container"">
                                <div class=""listing-item text-center"">
                                    <div class=""mostviewed-bg"" style=""background-image: url('assets/images/most-img-3.jpg')"">
                                        <div class=""listing-item-content"">
                                            <div class=""list-logo"">
                                                <a> <img src=""assets/images/logo-2.png"" width=""80"" height=""80"" alt=""logo""");
            WriteLiteral(@"></a>
                                            </div>
                                ...
                                <div class=""listing-item text-center"">
                                    <div class=""mostviewed-bg"" style=""background-image: url('assets/images/most-img-2.jpg')"">
                                        <div class=""listing-item-content"">
                                            ...
                                            <span class=""badge badge-pill badge-primary t");
            WriteLiteral(@"ext-uppercase open-close-banner"">Open</span>
                                        </div>
                                        <span class=""round-pill like-banner d-block bg-primary""><i class=""fa fa-heart-o""></i></span>
                                    </div>
                                </div>
                            ...
                            <div class=""listing-item-container"">
                                <div class=""listing-item text-center"">
                                    <div class=""mostviewed-bg"" style=""background-image: url('assets/images/most-img-1.jpg')"">
                                        <div class=""listing-item-content"">
                                            <div class=""list-logo"">
                                                <a> <img src=""assets/images/logo-4.");
            WriteLiteral(@"png"" width=""80"" height=""80"" alt=""list-logo""></a>
                                            </div>
                                            <span class=""badge badge-pill badge-primary text-uppercase category-banner"">Eat & Drink</span>
...
<");
            WriteLiteral(@"div class=""block-space bg-primary"">
    <div class=""container"">
        <div class=""block-head text-center mb-5"">
    ...
    <div class=""container"">
        <div class=""row row-grid mt-5"">
            <div class=""col-lg-4 text-center"">
                ...
                <p class=""text-white mt-3"">Proin dapibus nisl ornare diam varius tempus. Aenean a quam l");
            WriteLiteral(@"uctus, finibus tellus ut, convallis eros sollicitudin turpis.</p>
            </div>
            <div class=""col-lg-4 text-center"">
                <div class=""icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-primary"">
            ...
            <div class=""col-lg-4 text-center"">
                ...
                <p class=""text-white mt-3"">Faucibus ante, in porttitor tellus blandit et. Phasellus tincidunt metus lectus sollicitudin ");
            WriteLiteral(@"feugiat pharetra consectetur.</p>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class=""col-lg-4"">
                        <div class=""card card-lift--hover shadow border-0"">
                            ...
                            <div class=""card-body py-4"">
                                ...
                                <p>22 August 2018</p>
                                <p class=""description mb-4"">Sed sed tristique nibh iam porta volutpat finibus. D");
            WriteLiteral(@"onec in aliquet urneget mattis lorem. Pellentesque pellentesque</p>
