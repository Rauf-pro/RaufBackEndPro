        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ReceptPhone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ComplantPhone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LocAddress = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortInfo = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkingProsses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Address = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    AboutRestaurantId = table.Column<int>(type: "int", nullable: false),
                    LocationId = table.Column<int>(type: "int", nullable: false),
                    ContactInfoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestFullLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestFullLists_AboutRestaurants_AboutRestaurantId",
                        column: x => x.AboutRestaurantId,
                        principalTable: "AboutRestaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestFullLists_ContactInfos_ContactInfoId",
                        column: x => x.ContactInfoId,
                        principalTable: "ContactInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestFullLists_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestFullListId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pricings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pricings_RestFullLists_RestFullListId",
                        column: x => x.RestFullListId,
                        principalTable: "RestFullLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pricings_RestFullListId",
                table: "Pricings",
                column: "RestFullListId");

            migrationBuilder.CreateIndex(
                name: "IX_RestFullLists_AboutRestaurantId",
                table: "RestFullLists",
                column: "AboutRestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_RestFullLists_ContactInfoId",
                table: "RestFullLists",
                column: "ContactInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_RestFullLists_LocationId",
                table: "RestFullLists",
                column: "LocationId");
        }
